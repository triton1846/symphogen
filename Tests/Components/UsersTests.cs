...
public class UsersTests : BaseTestContext
{
    ...
    public async Task UsersTable_LoadsCorrectEnvironmentData()
    {
        ...
        // Assert
        UserServiceMock.Verify(m => m.GetAsync(MimerEnvironment.QA, It.IsAny<Func<IQueryable<User>, IQueryable<User>>?>()), Times.Once);
    ...
    public async Task UsersTable_DeletesUser_WhenDeleteButtonClicked()
    {
        ...
        // Assert
        UserServiceMock.Verify(m => m.DeleteAsync(MimerEnvironment.QA, userToDelete.Id), Times.Once);
        Assert.NotNull(table.Instance.Items);
    ...
    public async Task UsersTable_SavesUser_WhenSaveButtonClicked()
    {
        ...
        // Assert
        UserServiceMock.Verify(m => m.SaveAsync(MimerEnvironment.QA, userToSave), Times.Once);
        Assert.NotNull(table.Instance.Items);
        Assert.NotEmpty(table.Instance.Items);
    ...
    public async Task UsersTable_FilterCorrectly_WhenFilterApplied()
    {
        ...
        UserServiceMock.Setup(m => m.GetAsync(MimerEnvironment.QA, It.IsAny<Func<IQueryable<User>, IQueryable<User>>?>()))
            .ReturnsAsync(users);
